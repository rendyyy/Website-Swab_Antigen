  ...
  <div class="profile-nav col-md-3">
      <div class="panel">
          ...
          <ul class="nav nav-pills nav-stacked" style="display: block!important;">
              ...
              <li class="active"><a href="riwayat.php"> <i class="fa fa-file"></i> Riwayat Pemeriksaan </a></li>
          </ul>
      </div>
  </div>
...
<ul class="responsive-table">
      ...
      <div class="col col-2">Tanggal</div>
      <div class="col col-3">Nama Pasien</div>
      <div class="col col-2">Nomor Lab</div>
      <div class="col col-2">Hasil</div>
    </li>
    </ul>
     <?php if($cek > 0){ ?>
                <?php
    ...
    <li class="table-row">
      <div class="col col-2" ><?= date('d-m-Y', strtotime($d['Tgl_Pemeriksaan'] )) ;?></div>
      <div class="col col-3" ><?= $d['Nama_Lengkap']  ;?></div>
      <div class="col col-2" ><?= $d['No_Lab']  ;?></div>
      <div class="col col-2" >
    <a href="cetak.php?email=<?= $data['Email_Pasien'] ?>&idHasil=<?= $d['Id_Pemeriksaan'] ?>" target="_blank" class="btn btn-info my-2 my-sm-0" >Cetak Hasil</a>
